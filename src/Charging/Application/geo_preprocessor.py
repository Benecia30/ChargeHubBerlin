from src.Charging.infrastructure.csv_loader import StationDataRepository
from src.Charging.Domain.services.geo_services import GeoDataProcessor
...
class GeoApplicationService:
    ...
    def __init__(self):
        self.csv_data = StationDataRepository()
