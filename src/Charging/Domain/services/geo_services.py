...
class GeoDataProcessor:
    ...
    def sort_by_plz_add_geometry(dfr, dfg):
        ...
        sorted_df3['station_id'] = random.sample(range(1000, 10000), len(sorted_df3))
        print(sorted_df3['station_id'].describe())
    ...
    def preprocess_lstat_data(dfr, dfg):
        ...
        dframe2 = dframe.loc[:,
                  ['Postleitzahl','Straße','Betreiber', 'Bundesland', 'Breitengrad', 'Längengrad', 'Nennleistung Ladeeinrichtung [kW]','Anzahl Ladepunkte','Art der Ladeeinrichung']]
